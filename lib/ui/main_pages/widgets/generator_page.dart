                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ElevatedButton(
                              onPressed: () {
                                // Handle button press
                                model.addOrRemoveBodyPart(bodyPart);
                              },
                              style: ButtonStyle(
                                backgroundColor: WidgetStateProperty.all(
                                  model.selectedBodyParts.contains(bodyPart)
                                      ? Theme.of(context).colorScheme.primary
                                      : Colors.white,
                                ),
                                side: WidgetStatePropertyAll(
                              ...
                              child: FittedBox(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    color:
                                        model.selectedBodyParts.contains(
                                          bodyPart,
                                        )
                                        ? Colors.white
                                        : Theme.of(context).colorScheme.primary,
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ElevatedButton(
                              ...
                              style: ButtonStyle(
                                backgroundColor: WidgetStateProperty.all(
                                  model.selectedDays.contains(day)
                                      ? Theme.of(context).colorScheme.primary
                                      : Colors.white,
                                ),
                                side: WidgetStatePropertyAll(
                              ...
                              child: FittedBox(
                                child: Text(
                                  day.name,
                                  style: TextStyle(
                                    color: model.selectedDays.contains(day)
                                        ? Colors.white
                                        : Theme.of(context).colorScheme.primary,
                                  ),
                                ),
